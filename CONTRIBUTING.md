...
Discussion of this work occurs on the [One Time Password Authentication
Working Group mailing list](mailto:ietf-otp@research.telcordia.com)
([archive](ftp://ftp.research.telcordia.com/pub/ietf-otp/archive),
[subscribe](ietf-otp-request@research.telcordia.com)).
...
[Working Group documents](https://datatracker.ietf.org/wg/otp/documents/).
